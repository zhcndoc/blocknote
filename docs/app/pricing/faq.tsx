...
const faqs = [
  {
    ...
    answer: (
      <>
        我们自豪地宣布 BlockNote 是 100% 开源软件。 核心库采用
        <a href="https://www.mozilla.org/en-US/MPL/2.0/">MPL 2.0 许可证</a>
        授权， 这允许你在商业和闭源应用中使用
        BlockNote——即使没有订阅也可以。如果你对 BlockNote 的源文件进行了修改，
        你需要公开这些修改，以便更广泛的社区也能受益。
        <br />
  ...
  },
  {
    ...
    answer: (
      <>
        只有当您使用任何 XL 套件（如 AI 集成、多列布局和导出器），并且无法遵守
        GPL-3.0 许可证时，您才需要一份
        <Link href="/legal/blocknote-xl-commercial-license">商业许可证</Link>
        。这通常发生在您构建闭源应用程序时。BlockNote
        商业订阅及以上版本包含商业许可证。
      </>
    ),
  },
  ...
  },
  {
    ...
    answer: (
      <>
        我们为您提供保障！所有 BlockNote 订阅均享有优先支持服务。具体详情请参见
        <Link href="/legal/service-level-agreement">服务级别协议</Link>。
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        的确切细节。
        <br />
        如果您想在多个应用中使用 XL 套件，请通过 team@blocknotejs.org
        联系我们；我们很乐意与您合作定制许可证。
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        ...
        <Link href="/legal/blocknote-xl-commercial-license">商业许可条款</Link>{" "}
        的确切细节。
      </>
    ),
  },
